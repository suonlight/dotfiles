...
#+BEGIN_SRC shell :async :results output
brew install emacs-plus@30 --with-native-comp --with-modern-sexy-v1-icon
#+END_SRC
...
asdf set ripgrep $(ls ~/.asdf/installs/ripgrep/ | sort -r | head -n 1)
#+end_src

#+begin_src shell :async :results output
asdf plugin add fd
asdf install fd latest
asdf set fd $(ls ~/.asdf/installs/fd/ | sort -r | head -n 1)
#+end_src

#+begin_src shell :async :results output
asdf plugin add fzf https://github.com/kompiro/asdf-fzf.git
asdf install fzf latest
asdf set fzf $(ls ~/.asdf/installs/fzf/ | sort -r | head -n 1)
#+end_src

#+begin_src shell :async :results output
asdf plugin-add yq https://github.com/sudermanjr/asdf-yq.git
asdf install yq latest
asdf set yq $(ls ~/.asdf/installs/yq/ | sort -r | head -n 1)
#+end_src
...
asdf set bat $(ls ~/.asdf/installs/bat/ | sort -r | head -n 1)
#+end_src
...
asdf global java adoptopenjdk-23.0.1+11
#+end_src
...
https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/FiraCode/Regular/FiraCodeNerdFont-Regular.ttf
